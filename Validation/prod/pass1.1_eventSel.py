...
samples = {
    'data nominal syst':[
        ...
        "DoubleEG_Run2015C", "DoubleEG_Run2015D", 
        "DoubleMuon_Run2015C", "DoubleMuon_Run2015D", 
        "MuonEG_Run2015C", "MuonEG_Run2015D", 
    ],
    'bkg nominal syst systMC':[
        ...
        "DYJets", "DYJets_10to50", "DYJets_MG", "DYJets_MG_5to50", 
    ...
    'sig nominal scaleup':[
        ...
        ## cmsRun analyze_sig_cfg.py
        ## do ttbar specific gen level analyzer, do ttbar-dilepton genFilters
        "TTLL_powheg_scaleup", "TT_powheg_scaleup", "TTJets_scaleup", 
    ],
    'sig nominal scaledn':[
        "TTLL_powheg_scaledown", "TT_powheg_scaledown", "TTJets_scaledown",
    ],
    'sig nominal':[
        ...
        ## cmsRun analyze_sig_cfg.py
        ## do ttbar specific gen level analyzer, do ttbar-dilepton genFilters
        "TTJets_MG5", "TTJets_aMC", 
        "TT_amcatnlo-herwigpp", "TT_powheg-evtgen", "TT_powheg-herwigpp", 
