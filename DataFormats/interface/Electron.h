...
namespace cat
{
	...
	public:
		...
		Electron(Double_t px, Double_t py, Double_t pz, Double_t e) :
		    Lepton(px,py,pz,e),
		    trackerDrivenSeed_(false),
		    ecalDrivenSeed_(false),
		    ecalDrivenMomentum_(),
		...
		Electron(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z) :
		    Lepton(px,py,pz,e,vtx_x,vtx_y,vtx_z),
		    trackerDrivenSeed_(false),
		    ecalDrivenSeed_(false),
		    ecalDrivenMomentum_(),
		    eSuperClusterOverPin_(-9999.),
		...
		Electron(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z, Int_t type, Int_t charge) :
		    Lepton(px,py,pz,e,vtx_x,vtx_y,vtx_z,type,charge),
		    trackerDrivenSeed_(false),
		    ecalDrivenSeed_(false),
		    ecalDrivenMomentum_(),
		    eSuperClusterOverPin_(-9999.),
		...
		Electron(const TLorentzVector &momentum) :
		    Lepton(momentum),
		    trackerDrivenSeed_(false),
		    ecalDrivenSeed_(false),
		    ecalDrivenMomentum_(),
		    ...
		    {;}
                ...
                Electron(const TLorentzVector &momentum, const TVector3 &vertex, Int_t type, Float_t charge) :
		    Lepton(momentum, vertex, type, charge),
		    trackerDrivenSeed_(false),
		    ecalDrivenSeed_(false),
		    ecalDrivenMomentum_(),
		    eSuperClusterOverPin_(-9999.),
	...
	public:
	        virtual TString typeName() const { return "Electron"; }
		...
		friend std::ostream& operator<< (std::ostream& stream, const Electron& electron) {
			stream << "Electron - Charge=" << electron.charge() << " (Et,eta,phi)=("<< electron.Et() <<","<< electron.Eta() <<","<< electron.Phi() << ")"
