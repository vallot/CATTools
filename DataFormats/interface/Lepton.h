...
namespace cat
{
	...
	public:
			...
			{;}
                ...
                Lepton(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z) :
                ...
                Lepton(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z, Int_t type, Int_t charge) :
                ...
                Lepton(const TLorentzVector &momentum) :
                        Particle(momentum),
                        ip3d_(-9999.),
                        ip3dErr_(-9999.),
                        d0_(-9999.),
                ...
                Lepton(const TLorentzVector &momentum, const TVector3 &vertex, Int_t type, Float_t charge) :
	...
	public:
		virtual TString typeName() const { return "Lepton"; }
