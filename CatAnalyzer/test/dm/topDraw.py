...
sgfilelist = ['TT_powheg', 'WJets', 'SingleTbar_tW', 'SingleTop_tW', 'ZZ', 'WW', 'WZ', 'DYJets', 'DYJets_10to50']
...
'''
#rd_tcut = '%s&&(jet1_pt+jet2_pt)<400&&acos(cos(lep1_phi-lep2_phi))<2&&%s'%(stepch_tcut,cut) # met
#rd_tcut = '%s&&(jet1_pt+jet2_pt)<400&&met>320&&acos(cos(lep1_phi-lep2_phi))<2&&%s'%(stepch_tcut,cut) #leppt
#rd_tcut = '%s&&met>320&&acos(cos(lep1_phi-lep2_phi))<2&&%s'%(stepch_tcut,cut) # jetpt
rd_tcut = '%s&&(jet1.Pt()+jet2_pt)<400&&met>320&&%s'%(stepch_tcut,cut) #dphi
