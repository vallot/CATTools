...
def drawTH1(name, cmsLumi, mclist, data, x_name, y_name, doLog=False, doRatio=True, ratioRange=0.45, siglist=None, legmarginx=0.0):
    #leg = ROOT.TLegend(0.58, 0.78, 0.8, 0.9)
    leg = ROOT.TLegend(0.71 + legmarginx, 0.68, 0.88, 0.91)
    leg.SetBorderSize(0)
    #leg.SetNColumns(2)
