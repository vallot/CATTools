...
plotvar_l = ["dilep.M\(\)", "njet", "met", "nbjet",
			 ...
			 "partonttbar.Pt\(\)", "partonttbar.Rapidity\(\)", "partonttbar.M\(\)", "partonttbar_dphi",  "d0.M\(\)","dstar.M\(\)","((dstar_dau1+dstar_dau2+dstar_dau3)-(dstar_dau1+dstar_dau2)).M\(\)"]
x_name_l  = ["M(ll) [GeV/c^{2}]", "Jet Multiplicity", "Missing Et [GeV]", "b Jet Multiplicity",
			 ...
			 "TTbar p_{T} [GeV/c]", "TTbar Rapidity", "TTbar Mass [GeV/c^{2}]", "TTbar #Delta#phi","Mass of D0 Cands","Mass of Dstar Cands", "Mass difference"]
binset_l  = ["[60,20,320]", "[10,0,10]", "[20,0,200]", "[6,0,6]",
			 "[10,0,300]", "[10,-2.5,2.5]",
			 "[10,0,300]", "[10,-2.5,2.5]",
			 "[20,0,500]", "[10,-2.5,2.5]",
			 "[10,0,400]", "[10,-2.5,2.5]", "[10,200,1200]", "[10,0.0,3.141592]","[100,1.6,2.2]","[100,1.6,2.2]","[100,0.135,0.17]"]
