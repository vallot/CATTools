...
create-batch --jobName TTWJetsToLNu --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TTWJetsToLNu.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TTWJetsToLNu --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName TTWJetsToQQ --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TTWJetsToQQ.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TTWJetsToQQ --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName TTZToLLNuNu --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TTZToLLNuNu.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TTZToLLNuNu --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName TTZToQQ --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TTZToQQ.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TTZToQQ --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName ttHTobb --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_ttHTobb.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/ttHTobb --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName ttHToNonbb --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_ttHToNonbb.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/ttHToNonbb --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName ST_TH_1L3B_Hct --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_ST_TH_1L3B_Hct.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/ST_TH_1L3B_Hct --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName ST_TH_1L3B_Hut --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_ST_TH_1L3B_Hut.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/ST_TH_1L3B_Hut --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName TT_TH_1L3B_aTLep_Hut --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TT_TH_1L3B_aTLep_Hut.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TT_TH_1L3B_aTLep_Hut --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName TT_TH_1L3B_TLep_Hut --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TT_TH_1L3B_TLep_Hut.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TT_TH_1L3B_TLep_Hut --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName TT_TH_1L3B_aTLep_Hct --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TT_TH_1L3B_aTLep_Hct.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TT_TH_1L3B_aTLep_Hct --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'

create-batch --jobName TT_TH_1L3B_TLep_Hct --fileList $CMSSW_BASE/src/CATTools/CatAnalyzer/data/dataset/dataset_TT_TH_1L3B_TLep_Hct.txt --cfg testAnalyzer_cfg.py --transferDest /store/user/jipark/cat_test_V9_7/TT_TH_1L3B_TLep_Hct --maxFiles 20 --args 'UserJSON=false runOnTTbarMC=2'
