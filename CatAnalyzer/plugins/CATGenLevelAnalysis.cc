...
private:
  ...
  std::vector<TH1F*> hComParton_; // Parton particle common phase space parton level
  std::vector<TH1F*> hComPseudo_; // Parton particle common phase space particle level
