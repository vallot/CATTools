...
void dileptonCommon::setBranch(TTree* tree, int sys) {
  setCommonBranch(tree, sys);
  setCustomBranch(tree, sys);
}

void dileptonCommon::setCustomBranch(TTree* tree, int sys) {}

void dileptonCommon::setCommonBranch(TTree* tr, int sys) {
...
void dileptonCommon::analyzeCustom(int sys) {
