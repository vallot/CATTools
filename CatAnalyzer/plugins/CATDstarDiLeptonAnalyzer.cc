#include "CATTools/CatAnalyzer/interface/CATDstarDiLeptonAnalyzer.h"
...
void CATDstarDiLeptonAnalyzer::setBranchCustom(TTree* tr, int sys) {
...
shared_ptr<TLorentzVector> CATDstarDiLeptonAnalyzer::mcMatching( vector<TLorentzVector>& aGens, TLorentzVector& aReco) {
  float minDR= 999.;
  //float minRelPt = 1.0;
...
void CATDstarDiLeptonAnalyzer::endJob() {
  showSummary();
}

CATDstarDiLeptonAnalyzer::CATDstarDiLeptonAnalyzer(const edm::ParameterSet& iConfig ) :TopEventCommon(iConfig) 
{
...
void CATDstarDiLeptonAnalyzer::showSummary() {
...
void CATDstarDiLeptonAnalyzer::analyzeCustom(const edm::Event& iEvent, const edm::EventSetup& iSetup, int sys) {
...
void CATDstarDiLeptonAnalyzer::resetBranchCustom()
{
