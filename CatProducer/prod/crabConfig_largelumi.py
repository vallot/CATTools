...
config.General.requestName = "V9_1_test_W1JetsToLNu_LHEWpT_150-250_TuneCP5_13TeV-amcnloFXFX-pythia"
...
config.Data.outLFNDirBase = '/store/group/CAT/V9_1_test/W1JetsToLNu_LHEWpT_150-250_TuneCP5_13TeV-amcnloFXFX-pythia8' 
#config.Site.storageSite = 'T3_US_FNALLPC'
config.Site.blacklist = ['T2_US_Florida']

config.Data.outputDatasetTag='V9_1_RunIIFall17MiniAOD-94X_mc2017_realistic_v11-v1'
