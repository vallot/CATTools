...
namespace cat
{
	class CatCaloJet : public CatJet
	{
	...
	public:
		...
		CatCaloJet(const CatCaloJet& jet) :
			CatJet(jet)
		...
		CatCaloJet(Double_t px, Double_t py, Double_t pz, Double_t e) :
			CatJet(px,py,px,e)
			,etaetaMoment_(-9999.)
			,phiphiMoment_(-9999.)
			,ecalEnergyFraction_(-9999.)
		...
		CatCaloJet(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z) :
		...
		CatCaloJet(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z, Int_t type, Float_t charge) :
		...
		CatCaloJet(const TLorentzVector &momentum) :
			CatJet(momentum)
			,etaetaMoment_(-9999.)
			,phiphiMoment_(-9999.)
			,ecalEnergyFraction_(-9999.)
		...
		CatCaloJet(const TLorentzVector &momentum, const TVector3 &vertex, Int_t type, Float_t charge) :
		...
		virtual TString typeName() const { return "CatCaloJet"; }
		...
		friend std::ostream& operator<< (std::ostream& stream, const CatCaloJet& jet) {
			stream << "CatCaloJet - Charge=" << setw(2) << jet.charge() << " (Et,eta,phi)=("<< setw(10) << jet.Et() <<","<< setw(10) << jet.Eta() <<","<< setw(10) << jet.Phi() << ")"
