...
catJetsPuppi = catJets.clone(
    ...
    jetResFile   = cms.string("CATTools/CatProducer/data/JER/Fall17_V3_MC_PtResolution_AK4PFPuppi.txt"),
    jetResSFFile = cms.string("CATTools/CatProducer/data/JER/Fall17_V3_MC_SF_AK4PFPuppi.txt"),
)
