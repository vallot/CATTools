...
catJets = cms.EDProducer('CATJetProducer',
    ...
    jetResFile   = cms.string("CATTools/CatProducer/data/JER/Autumn18_V1_MC_PtResolution_AK4PFchs.txt"),
    jetResSFFile = cms.string("CATTools/CatProducer/data/JER/Autumn18_V1_MC_SF_AK4PFchs.txt"),
