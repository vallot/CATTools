...
process.ntuple = cms.EDAnalyzer("GenericNtupleMaker",
    ...
    int = cms.PSet(
        nVertex   = cms.InputTag("recoEventInfo","pvN"),
        HLTDoubleMu = cms.InputTag("recoEventInfo","HLTDoubleMu"),
        HLTDoubleEl = cms.InputTag("recoEventInfo","HLTDoubleEl"),
        HLTMuEl = cms.InputTag("recoEventInfo","HLTMuEl"),
        HLTSingleMu = cms.InputTag("recoEventInfo","HLTSingleMu"),
        HLTSingleEl = cms.InputTag("recoEventInfo","HLTSingleEl"),
    ),
    float = cms.PSet(
        puWeight   = cms.InputTag("pileupWeight"),
        puWeightUp = cms.InputTag("pileupWeight", "up"),
        puWeightDn = cms.InputTag("pileupWeight", "dn"),
        pvX   = cms.InputTag("recoEventInfo","pvX"),
        pvY   = cms.InputTag("recoEventInfo","pvY"),
        pvZ   = cms.InputTag("recoEventInfo","pvZ"),
    ),
    floats = cms.PSet(
