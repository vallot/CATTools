...
// https://twiki.cern.ch/twiki/pub/CMSPublic/GenHFHadronMatcher/GenHFHadronMatcher.cc
// git cms-addpkg PhysicsTools/JetMCAlgos
// mv CATTools/CommonTools/test/GenHFHadronMatcher.cc PhysicsTools/JetMCAlgos/plugins/ 
